                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title mb-0 align-content-center">Danh Sách banner</h5>
                            <a href="{{ route('admins.banner.create') }}" class="btn btn-success">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <!-- Sửa -->
                                                        <a href="{{ route('admins.banner.edit', $item->id) }}" class="btn btn-outline-primary btn-sm me-2">
                                                            <i class="mdi mdi-pencil text-muted fs-14"></i>
                                                        </a>

                                                        <!-- Xóa -->
                                                        <form action="{{ route('admins.banner.destroy', $item->id) }}" method="POST" class="d-inline me-2">
                                                            @csrf
                                                            @method('DELETE')
