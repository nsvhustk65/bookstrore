            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admins.products.update', $listProduct->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ten_san_pham" name="ten_san_pham"
                                                ...
                                                is-invalid @enderror"
                                                value="{{ $listProduct->ten_san_pham }}">
                                            @error('ten_san_pham')
                                                <p>{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="gia_san_pham" name="gia_san_pham"
                                                ...
                                                is-invalid @enderror"
                                                value="{{ $listProduct->gia_san_pham }}">
                                            @error('gia_san_pham')
                                                <p>{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="gia_khuyen_mai" name="gia_khuyen_mai"
                                                ...
                                                is-invalid @enderror"
                                                value="{{ $listProduct->gia_khuyen_mai }}">
                                            ...
                                            <select name="category_id" class="form-select">
                                                @foreach ($listCategory as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $listProduct->category_id == $item->id ? 'selected' : '' }}>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="author_id" class="form-select">
                                                @foreach ($listAuthor as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $listProduct->author_id == $item->id ? 'selected' : '' }}>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="publisher_id" class="form-select">
                                                @foreach ($listPublisher as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $listProduct->publisher_id == $item->id ? 'selected' : '' }}>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-8 ">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="mo_ta" id="" rows="5" class="form-control">{{ $listProduct->mo_ta }}</textarea>
                                            @error('mo_ta_ngan')
                                                <p>{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <img id="img_product" src="{{ Storage::url($listProduct->image) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                <tbody id="image-table-body">
                                                    @foreach ($listProduct->imageProduct as $index=>$hinhAnh)
                                                        <tr>
                                    ...
                                    <div class="d-flex"><button type="submit" class="btn btn-primary">sửa sản phẩm</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var rowCount = {{count($listProduct->imageProduct)}};
